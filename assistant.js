...
function formatAIResponse(data) {
    ...
    if (task_type === 'image' && content && content.primary_url) {
        return `
            ...
            <details style="margin-top: 10px; font-size: 0.85em; opacity: 0.8;">
                ...
                <p><strong>Claude voted:</strong> ${arbitration.claude_vote.recommended} (${(arbitration.claude_vote.confidence * 100).toFixed(0)}% confident)<br>
                <em>${arbitration.claude_vote.reasoning}</em></p>
                <p><strong>Grok voted:</strong> ${arbitration.grok_vote.recommended} (${(arbitration.grok_vote.confidence * 100).toFixed(0)}% confident)<br>
                <em>${arbitration.grok_vote.reasoning}</em></p>
                <p><strong>Decision:</strong> ${arbitration.decision}</p>
                <p><strong>Cost:</strong> $${costs.total.toFixed(4)} (arbitration: $${costs.arbitration.toFixed(4)}, execution: $${costs.execution.toFixed(2)})</p>
            </details>
        `;
    }
